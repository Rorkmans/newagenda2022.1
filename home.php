...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img2/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Arcanjo</a>
        </div>
      </div>
                  ...
                  if(isset($_POST['btnCContato'])){
                      ...
                      if(in_array($extensao, $formatP)){
                        ...
                        if(move_uploaded_file($temporario, $pasta.$novoNome)){
                          $cadastro = "INSERT INTO tbContato (nomeContato,telefoneContato,emailContato,fotoContato) VALUES (:nome, :telefone, :email, :img)";
                          try{
